...
register(name="mosh", website="https://mosh.org", deps={'ncurses', 'protobuf', 'zlib'},
...
register(name="vim", website="https://www.vim.org/", deps={'ncurses'}, url="git@github.com:vim/vim.git",
         builder=configure_helper(build_path='.'))

register(name="curl", website="https://curl.haxx.se/", url="http://curl.haxx.se/download/curl-{{version}}.tar.gz",
         builder=configure_helper())

register(name="git", website="https://git-scm.com/", deps={'zlib', 'curl'},
         url="https://mirrors.edge.kernel.org/pub/software/scm/git/git-{{version}}.tar.gz",
         builder=configure_helper())

register(name="zsh", website="http://www.zsh.org", deps={'ncurses'},
...
register(name="cmake", website="https://cmake.org/", url="git@github.com:Kitware/CMake.git",
         builder=configure_helper())

register(name="shadowsocks-libev", deps={'libsodium', 'libev', 'mbedtls', 'c_ares', 'pcre'},
