...
register(name="bzip2",
         ...
         url="https://nchc.dl.sourceforge.net/project/bzip2/bzip2-{{version}}.tar.gz",
         builder=builder_helper(type="custom", cmd="make && make install PREFIX={{install_path}}",
                                build_path='.', src_path='.'))

register(name="polipo",
