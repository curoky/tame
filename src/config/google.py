...
register(name="protobuf", website="https://developers.google.com/protocol-buffers/",
...
register(name="glog", deps={'gflags'}, url="git@github.com:google/glog",
         builder=cmake_helper("-DBUILD_SHARED_LIBS=OFF"))

register(name="snappy", deps={'gtest'}, url="git@github.com:google/snappy.git",
         builder=cmake_helper("-DSNAPPY_BUILD_TESTS=OFF"))

register(name="double-conversion", url="git@github.com:google/double-conversion.git",
